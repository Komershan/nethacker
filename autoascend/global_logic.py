...
GRIND_XL = 5
# hypothesis: leaving Dlvl 1 at Xp 5 (~45 max HP) sends most roles into the Mines pick hunt /
# stair dive underpowered -- per-seed results show most games dying at Dlvl 2-5 at Xp 5-7 to
# rothes, soldier ants, werejackals and dwarves. Grinding the safe Dlvl 1 on to Xp 8 (0.075 banked
# and ~double the HP) before leaving lets them survive the descent. Barbarians already hit hard
# enough at Xp 5 and lose depth to the longer grind, so they keep GRIND_XL; pick carriers still dig
# from EARLY_DIG_XL. (Port of hub idea #1, Komershan 5deb412.)
LONG_GRIND_XL = 8
    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                grind_xl = GRIND_XL if self.agent.character.role == Character.BARBARIAN else LONG_GRIND_XL
