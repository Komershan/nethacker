...
class GlobalLogic:
    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            elif self.milestone == Milestone.DIVE:
                # hypothesis: after farming Dlvl 1 up to Xp 8, the old plan (fully explore
                # every level, then Mines/Sokoban) spends thousands of turns on shallow levels
                # and usually dies at Dlvl 2-5 still at Xp 8 (0.075). Depth is worth far more
                # than slow Xp gains (Dlvl 9 ~ Xp 9, Dlvl 10+ beats Xp 9), and an Xp 8 character
                # can survive the early main dungeon, so dive the Dungeons of Doom instead:
                # take the downstairs as soon as they are found, without the full-exploration
                # preempt (still resting to 80% HP before moving on).
            ...
            diving = self.milestone == Milestone.DIVE
            (
